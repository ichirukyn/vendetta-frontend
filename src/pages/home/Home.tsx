  ...
  return (
    <div className="main__block block_column p_40 w_100p">
      ...
      <div className="block_column align-start">
        <Link to={pathRoutes.arena.base} className="tab_active text_title">
          Арена ☠️
        </Link>
        <Link to={pathRoutes.enemy.base} className="tab_active text_title">
          Противники ☠️
        </Link>
        {/*<Link to={pathRoutes.hero.base} className='tab_active text_title'>Игроки 👤</Link>*/}
        <br />

        <Link to={pathRoutes.technique.base} className="tab_active text_title">
          Техники ⚔️
        </Link>
        <Link to={pathRoutes.spell.base} className="tab_active text_title">
          Заклинания 🔮
        </Link>
        {/*<Link to={pathRoutes.branch.base} className='tab_active text_title'>Ветки техник ⚔️</Link>*/}
        <br />

        <Link to={pathRoutes.item.base} className="tab_active text_title">
          Предметы
        </Link>
